/*
  # Set up avatar storage for user profile pictures
  ...
  1. Changes
    ...
    - Create helper function to update avatar URL in profiles

  2. Security
    - Users can only upload/update/delete their own avatars
    - Public access to avatars of users with public profiles
    - Private access to avatars of users with private profiles

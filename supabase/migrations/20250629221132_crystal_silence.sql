/*
  # Force schema refresh and ensure location columns exist

  1. Changes
    - Ensure latitude, longitude, and last_location_update columns exist in profiles table
    - Force schema cache refresh by making a minor change
...
-- First, let's ensure the columns exist with proper error handling
DO $$
BEGIN

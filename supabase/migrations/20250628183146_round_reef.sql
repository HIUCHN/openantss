/*
  ...
  1. Changes
    ...
    - Create helper functions for avatar URL management
    - Ensure user-specific folder structure for better organization

  2. Security
    - Users can only upload/update/delete their own avatars
    - Public access to avatars of users with public profiles
    - Private avatars only accessible to their owners
    - Proper folder structure using user IDs for security

  3. Organization
    - Each user's avatars stored in their own folder (using user ID)
    - Consistent naming pattern for avatar files
    - Proper indexing and access patterns
*/

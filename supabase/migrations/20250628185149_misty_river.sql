/*
  ...
  1. Changes
    ...
    - Ensure user-specific folder structure for avatar organization
    - Fix permission issues with avatar uploads

  2. Security
    - Users can only upload/modify/delete their own avatars
    - Public profiles' avatars are publicly viewable
    - Private profiles' avatars are only visible to the owner
    - Proper folder structure ensures clean separation of user files

  3. Performance
    - Optimized policies for efficient access control
    - Proper indexing for avatar URL lookups
*/

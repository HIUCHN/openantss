/*
  # Create user_education table with proper error handling
  ...
  2. Security
    ...
    - Add policies for authenticated users to manage their own education records

  3. Performance
    - Add indexes for user_id and start_year
*/
...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Users can view their own education records" ON user_education;
  DROP POLICY IF EXISTS "Users can insert their own education records" ON user_education;
  DROP POLICY IF EXISTS "Users can update their own education records" ON user_education;
  DROP POLICY IF EXISTS "Users can delete their own education records" ON user_education;
EXCEPTION
